    ...
    >
      <div className="absolute inset-0">
        <OptimizedImage
          ...
          className="absolute inset-0 size-full max-w-none object-cover object-[center_46%] sm:object-[center_48%] md:object-[center_58%] wide:object-[center_89%]"
          priority
        />
      </div>
      <div className="relative z-10 mx-auto flex w-full max-w-page flex-col items-center px-5 pt-8 pb-12 sm:px-8 sm:pt-10 sm:pb-24 md:pt-12 md:pb-16 wide:h-full wide:px-gutter wide:pt-[9.44vw] wide:pb-0">
        <p
          data-reveal="heading"
        ...
        <h1
          data-reveal="heading"
          className="max-w-[716px] text-center font-medium text-[2rem] leading-none tracking-[-1.28px] text-navy-soft sm:text-[40px] wide:text-hero"
        >
      ...
      <div
        className="pointer-events-none relative h-[min(86vw,30rem)] sm:h-[min(78vw,38rem)] md:h-[min(62vw,40rem)] lg:h-[min(56vw,44rem)] wide:hidden"
        aria-hidden="true"
      />
    </section>
  )
